/**
 * Tipos y contratos TypeScript para el módulo de Cumplimiento PLD / UIF (LFPIORPI)
...
export interface ScreeningPrevioInfo {
  escritura_id: string;
  instrumento_numero?: number | string | null;
  fecha: string;
...
export interface ComparecientePldStatus {
  ...
  consultas: Record<string, PldConsulta>;
  screening_previo?: ScreeningPrevioInfo | null;
}
